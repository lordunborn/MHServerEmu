...
{
    /// <summary>
    /// Per-player log collator for Stash Affinity diagnostics.
    /// Buffers redirected stash-move decisions in memory and writes them to
    /// a dedicated file when the player session ends.
    /// </summary>
